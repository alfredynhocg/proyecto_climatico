...
<div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay">
                <div class="breadcrumbs-img">
                    <img src="{{ asset('assets/images/breadcrumbs/1.jpg') }}" alt="Breadcrumbs Image">
                </div>
                            ...
                            <div class="course-part clearfix">
                                ...
                                <div class="courses-item right">
                                    ...
                                    <div class="content-part">
                                        ...
                                        <h3 class="title"><a href="{{ route('course-single') }}">Introduction to Quantitativ and Qualitative</a></h3>
                                        <div class="bottom-part">
                                            <div class="info-meta">
                                                <ul>
                                                    <li class="user"><i class="fa fa-user"></i> 245</li>
