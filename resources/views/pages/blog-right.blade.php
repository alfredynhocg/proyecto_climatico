@extends('layouts.app', [
    'title' => 'Blog Right Sidebar - Educavo',
    'variant' => 'inner',
])
                        ...
                        <div class="widget-area">
                            ...
                            <div class="recent-posts-widget mb-50">
                                ...
                                <div class="show-featured ">
                                    <div class="post-img">
                                        <a href="#"><img src="{{ asset('assets/images/blog/style2/1.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="post-desc">
                                ...
                                <div class="show-featured ">
                                    <div class="post-img">
                                        <a href="#"><img src="{{ asset('assets/images/blog/style2/2.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="post-desc">
                                ...
                                <div class="show-featured ">
                                    <div class="post-img">
                                        <a href="#"><img src="{{ asset('assets/images/blog/style2/3.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="post-desc">
                                        <a href="#">Soundtrack filma Lady Exclusive Music </a>
                                        <span class="date">
                                ...
                                <div class="show-featured ">
                                    <div class="post-img">
                                        <a href="#"><img src="{{ asset('assets/images/blog/style2/5.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="post-desc">
                      ...
                      <div class="col-lg-8 pr-50 md-pr-15">
                          <div class="row">
                              ...
                              <div class="col-lg-12 mb-70">
                                  <div class="blog-item">
                                      <div class="blog-img">
                                          <a href="#"><img src="{{ asset('assets/images/blog/inner/6.jpg') }}" alt=""></a>
                                      </div>
                                      <div class="blog-content">
                                          <h3 class="blog-title"><a href="#">While the lovely valley team work</a></h3>
                                          <div class="blog-meta">
                              ...
                              <div class="col-lg-12 mb-70">
                                  <div class="blog-item">
                                      <div class="blog-img">
                                          <a href="#"><img src="{{ asset('assets/images/blog/inner/7.jpg') }}" alt=""></a>
                                      </div>
                                      <div class="blog-content">
                              ...
                              <div class="col-lg-12">
                                  <div class="blog-item">
                                      <div class="blog-img">
                                          <a href="#"><img src="{{ asset('assets/images/blog/inner/8.jpg') }}" alt=""></a>
                                      </div>
                                      <div class="blog-content">
                                          <h3 class="blog-title"><a href="#">This is a great source of content for anyone…</a></h3>
                                          <div class="blog-meta">
